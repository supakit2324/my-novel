...
import UpdateNovelTabContent from "@/components/novels/dashboard/dashboard-my-novel/id/edit-novel";

export const metadata = {
    title: "Dashboard Update Novel",
};

const DashboardAddNovel = () => {
    return (
        <>
            {/* Main Header Nav */}
            <DashboardHeader />
...
export default DashboardAddNovel;
